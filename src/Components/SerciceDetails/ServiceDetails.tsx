      ...
      <div className="container">
        <div className="cs_service_details">
          <div className="cs_banner cs_radius_50">
            <img src="/assets/img/service_img-1.jpg" alt="Service details banner" />
          </div>
          ...
          <div className="row cs_row_gap_30 cs_gap_y_30 cs_mb_32">
            <div className="col-md-6">
              <div className="cs_radius_20">
                <img src="/assets/img/service_img-2.jpg" alt="Service image" />
              </div>
            </div>
            <div className="col-md-6">
              <div className="cs_radius_20">
                <img src="/assets/img/service_img-3.jpg" alt="Service image" />
              </div>
            </div>
          </div>
